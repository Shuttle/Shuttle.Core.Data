...
namespace Shuttle.Core.Data.Tests
{
	...
	public class DatabaseGatewayFixture : Fixture
	{
		protected IDatabaseContext GetDatabaseContext(Mock<IDbCommand> command)
		{
			...
			return new DatabaseContextFactory(Provider.GetRequiredService<IOptionsMonitor<ConnectionStringOptions>>(), GetDbConnectionFactory(), commandFactory.Object, new ThreadStaticDatabaseContextCache()).Create(DefaultConnectionStringName);
		}
