...
{
    public class ConnectionSettingsValidator : IValidateOptions<ConnectionSettings>
    {
        public ValidateOptionsResult Validate(string name, ConnectionSettings options)
        {
